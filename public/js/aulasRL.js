...
const qtdAulasTotal = 6;  // Defina aqui a quantidade total de aulas no curso
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cursoId = 4;  // Substitua com o ID do curso correspondente
...
document.getElementById('m1a1RL').addEventListener('click', () => {aulaAtualId = 1;playVideo("https://www.youtube.com/embed/rlTMBCaezeU?si=ElgLpBElLpSy4Q_s")});
document.getElementById('m1a2RL').addEventListener('click', () => {aulaAtualId = 2;playVideo("https://www.youtube.com/embed/jKXW6Gv9TJo?si=2PUV2wjN-e6AySnW")});
document.getElementById('m2a1RL').addEventListener('click', () => {aulaAtualId = 3;playVideo("https://www.youtube.com/embed/dcOs728v6oE?si=bemeLhj_SF_dZkkw")});
document.getElementById('m3a1RL').addEventListener('click', () => {aulaAtualId = 4;playVideo("https://www.youtube.com/embed/b5D5VArKebk?si=5QUXSKDiHYbuc70b")});
document.getElementById('m4a1RL').addEventListener('click', () => {aulaAtualId = 5;playVideo("https://www.youtube.com/embed/NYI9bjrNwcU?si=hMGpvx4YIRT8mNwn")});
document.getElementById('m5a1RL').addEventListener('click', () => {aulaAtualId = 6;playVideo("https://www.youtube.com/embed/ia7KRhj76Cc?si=z7q0eYIeEzkLtbuX")});
